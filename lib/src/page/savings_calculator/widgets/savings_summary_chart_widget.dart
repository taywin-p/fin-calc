...
class SavingsSummaryChartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min, // เปลี่ยนเป็น min เพื่อไม่ให้ overflow
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                padding: const EdgeInsets.all(4), // ลด padding ของไอคอน
                decoration: BoxDecoration(
                  color: Colors.white.withOpacity(0.3),
                  borderRadius: BorderRadius.circular(8), // ลด border radius
                ),
                child: const Icon(Icons.account_balance_wallet_rounded, color: Colors.white, size: 16), // ลดขนาดไอคอน
              ),
              const SizedBox(width: 8), // ลด spacing
              const Text(
                'สรุปเงินรวมสุดท้าย',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 14, // เพิ่มขนาดฟอนต์ให้เหมาะสม
                ...
                children: [
                  Text(
                    ...
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 16, // เพิ่มขนาดฟอนต์ให้เหมาะสม
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 10, // เพิ่มขนาดฟอนต์ให้เหมาะสม
                    ),
                  ),
                ],
              ),
              const SizedBox(width: 12), // เพิ่ม spacing
              // แท่งกราฟ
              Expanded(
                child: Material(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        height: 25, // เพิ่มความสูงของแท่งกราฟให้เหมาะสม
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(8),
                      ...
                      child: Row(
                        children: [
                          // ส่วนที่ 1: เงินออมปัจจุบัน (สีม่วงอ่อน)
                          Expanded(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  ...
                                  colors: [
                                    const Color(0xFF667EEA), // สีน้ำเงินสวย
                                    const Color(0xFF764BA2), // สีม่วงน้ำเงิน
                                  ],
                                ),
                              ...
                              child: currentSavings / finalAmount > 0.15
                                  ? Center(
                                      child: Text(
                          ...
                          // ส่วนที่ 2: เงินฝากเพิ่ม (สีเขียวน้ำทะเล)
                          Expanded(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  ...
                                  colors: [
                                    const Color(0xFF11998E), // สีเขียวมิ้นต์สวย
                                    const Color(0xFF38EF7D), // สีเขียวสด
                                  ],
                                ),
                              ),
                              child: totalDeposits / finalAmount > 0.25
                                  ? Center(
                                      child: Text(
                          ...
                          // ส่วนที่ 3: ดอกเบี้ยรวม (สีทองอ่อน)
                          Expanded(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  ...
                                  colors: [
                                    const Color(0xFFF093FB), // สีชมพูฟิวเซีย
                                    const Color(0xFFF5576C), // สีแดงชมพูสวย
                                  ],
                                ),
                                borderRadius: const BorderRadius.only(
                              ...
                              child: totalInterest / finalAmount > 0.15
                                  ? Center(
                                      child: Text(
          ...
          const SizedBox(height: 12), // เพิ่ม spacing ระหว่างกราฟกับ legend
